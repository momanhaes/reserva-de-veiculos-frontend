...
* Por enquanto todos os usuários podem cadastrar veículos, mas em breve será implementada um fluxo de navegação por token usando JWT onde somentes usuários administradores poderão incluir veículos.
